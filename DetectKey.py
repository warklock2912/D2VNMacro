...
def buff():
    pyautogui.press("F3")
    time.sleep(0.3)
    pyautogui.click(button='right', x=1134, y=627)
    time.sleep(0.2)
    pyautogui.press("F4")
    time.sleep(0.3)
    pyautogui.click(button='right', x=1134, y=627)
...
def buffsor():
    pyautogui.press("F4")
    time.sleep(0.7)
    pyautogui.click(button='right', x=1036, y=553)
    time.sleep(0.2)
    pyautogui.press("F3")
    time.sleep(0.5)
    pyautogui.click(button='right', x=1036, y=553)
...
def teleport_to_waypoint_act1_125():
    ...
    pyautogui.press("F1")
    # step tele to waypoint
    pyautogui.click(button='right', x=1405, y=649)
    time.sleep(0.5)
    pyautogui.click(button='right', x=1419, y=536)
    time.sleep(0.5)
    # pyautogui.click(button='right', x=1098, y=504)
    # time.sleep(0.5)
    pyautogui.moveTo(1063, 561, 0.5)
    time.sleep(0.1)
    pyautogui.click(x=1063, y=561)
    time.sleep(0.5)
    # waypoint tab open
    click_image('sample/blackMarshWp.png', 'sample/bMConfirm.png', 0.9)
    print("Teleported to Black Marsh")
...
def sor_teleport_to_waypoint_act1_125():
    ...
    # step tele to waypoint
    time.sleep(1)
    pyautogui.click(button='right', x=1249, y=549)
    time.sleep(0.3)
    pyautogui.click(button='right', x=1249, y=549)
    time.sleep(0.3)
    pyautogui.press("F6")
    time.sleep(0.5)
    pyautogui.moveTo(1098, 504, 0.5)
    time.sleep(0.1)
    pyautogui.click(button='right',x=1098, y=504)
    time.sleep(0.5)
    # waypoint tab open
...
def tele_key1():
    ...
    time.sleep(0.5)
    pyautogui.click(button='right', x=743, y=403)
    time.sleep(0.5)
    pyautogui.click(button='right', x=755, y=427)
    time.sleep(0.5)
    pyautogui.click(button='right', x=643, y=289)
    time.sleep(0.5)
    pyautogui.click(button='right', x=643, y=289)
    time.sleep(0.5)
    # pyautogui.click(button='right', x=640, y=321)
